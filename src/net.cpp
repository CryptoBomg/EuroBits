...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EroBitsCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"216.158.226.226","216.158.226.226"},
    {"206.72.193.103","206.72.193.103"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EroBitsCoin is probably already running."), addrBind.ToString().c_str());
        else
